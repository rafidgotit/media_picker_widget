...
class _HeaderState extends State<Header> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    widget.controller.updateSelection = (selectedMediaList){
      if(widget.mediaCount==MediaCount.multiple) setState(()=>selectedMedia = selectedMediaList.cast<Media>());
      ...
      child: Row(
        ...
        children: [
          Padding(
            ...
            child: IconButton(icon: widget.decoration.cancelIcon ?? Icon(Icons.arrow_back_outlined), onPressed: (){
          ...
          Expanded(
            flex: 2,
            child: TextButton(
              style: ButtonStyle(overlayColor: MaterialStateProperty.all(Colors.grey.withOpacity(0.05)),),
              child: Row(
          ...
          if(widget.mediaCount == MediaCount.multiple) Expanded(
            flex: 1,
            child: AnimatedSwitcher(
              ...
              child: (selectedMedia.length>0)?TextButton(
                key: Key('button'),
                child: Row(
